...
<html>
    ...
    <body>
        ...
        <div id= "contenido"> 
            ...
            <h4> Metas de indicadores mensual</h4>
            <div class="form-inline">
                ...
                <div class="form-group">
                    <label id = "ConAste" for="NomItem"> Estado</label>
                    <div class="input-group">
                ...
                <table class = "table table-striped table-bordered table-hover table-condensed">
                    ...
                    <tbody>
                        <tr>    
                            ...
                            <th><button type="button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-trash"> </span></button></th>
                            <th>Activo</th>
                            <th>
                        ...
                        <tr>    
                            ...
                            <th>
                            <button type="button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-trash"></span></button></th>
                            <th>Activo</th>
                            <th><button type="button" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-refresh"> </span></th></button>
                            </th>
                        </tr>
                        <tr>    
