...
//EDITAR AQUI LOS MENSAJES DE ALERTA SEGÚN LA PROPIEDAD QUE SERÍA INGRESADA DE FORMA INVALIDA
	...
	messages: {
		...
		minlength: $.validator.format("Por favor ingrese más de {0} caracteres"),
		...
		max: $.validator.format("Por favor ingrese un valor menor que o igual a {0}"),
		min: $.validator.format("Por favor ingrese un valor mayor que o igual a {0}")
	},
