...
<title>ITEM'S facturables</title>
...
<div id= "contenido"> 
  ...
  <nav id="submenu"> 
    ...
    <a href="gestionuser.jsp">Usuarios</a>
  </nav>
    <div id = "ContenidoInterno">
       <a href="administraritemfacturable.jsp"> <button type="button" class="btn btn-success btn-xs"><span class="
glyphicon glyphicon-saved
" tabindex="4"> </span>Administrar</button> </a>
<div class="collapse alert alert-warning alert-dismissible fade" role="alert"  id="myModal"  tabindex="-1" role="dialog" aria-labelledby="myModal1" aria-hidden="true" >
  ...
  <strong>Atencion!</strong> No se ha registrado la informaciÃ³n por favor verifique los campos del formulario.
    ...
    <form id="CrearITEM" role="form" method="get" action="parametrizaritemfacturableok.jsp">
